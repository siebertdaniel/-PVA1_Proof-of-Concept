...
async function loginUser() {
    ...
    let url = "https://pva1.siebert.cloud/backend/loginUser"
    ...
    await fetch(url, {
        ...
        // If the http statuscode is 400 then the password was wrong
        ...
        if (res.status === 400) {
            ...
            alert("User nicht vorhanden. Bitte erneut versuchen!")
...
function checkLoginStatus() {
    ...
    if (sessionStorage.getItem("user_id") === null) {
        ...
        document.getElementById("linkToRegister").style.visibility = 'visible';
        document.getElementById("login-form").style.display = "block";
        document.getElementById('logoutButton').style.visibility = 'hidden';
        document.getElementById("infoText").innerHTML = "Sie sind derzeit nicht angemeldet.";
        ...
        document.getElementById("linkToRegister").style.display = "none";
        document.getElementById("login-form").style.display = "none";
        document.getElementById('logoutButton').style.visibility = 'visible';
        document.getElementById("infoText").innerHTML = "Sie sind derzeit angemeldet. Zum abmelden folgenden Button benutzen";
    }
}
